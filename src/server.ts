...
import { vehicleLoanRouter } from "./routes/vehicle";
...
app.use(seedRouter);
app.use(eligibilityRouter); // Checking if this needs to be here or protected? Keeping as is.

// Register Loan Calculators (Publicly accessible)
app.use("/api", businessLoanRouter);
app.use("/api", vehicleLoanRouter);
